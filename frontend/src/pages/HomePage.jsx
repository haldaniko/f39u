        ...
        <section>
          {stories.length ? (
            <div className="grid gap-6 lg:grid-cols-[1.35fr_0.9fr_0.9fr] lg:grid-rows-[210px_250px_190px_230px_210px]">
              <StoryCard article={stories[0]} variant="large" imageClassName="h-80" className="lg:col-start-1 lg:row-span-2 lg:row-start-1" />
              <StoryCard article={stories[7]} variant="popularCompact" className="lg:col-start-1 lg:row-start-3" />
              <StoryCard article={stories[8]} variant="popular" imageClassName="h-40" className="lg:col-start-1 lg:row-span-2 lg:row-start-4" />
