...
ALLOWED_HOSTS = os.getenv("ALLOWED_HOSTS", "fxlfm.com,www.fxlfm.com,localhost,127.0.0.1").split(",")
...
CELERY_BEAT_SCHEDULE = {
    ...
    "rewrite-news-every-15-min": {
        "task": "apps.ai.tasks.rewrite_pending_articles_task",
        "schedule": 900.0,
    },
    "cleanup-duplicates-daily": {
        "task": "apps.news.tasks.cleanup_duplicates_task",
        "schedule": 86400.0,
    },
    "generate-analytics-daily": {
        "task": "apps.analytics.tasks.generate_daily_report_task",
        "schedule": 86400.0,
    },
}
